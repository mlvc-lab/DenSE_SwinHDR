...
def define_G(opt):
    ...
    # ----------------------------------------
        ...
        netG_t = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
                   img_range=opt_net['img_range'],
    ...
    # SwinIR
    # ----------------------------------------
    elif net_type == 'swinir_d':
        from models.network_swinir import SwinIR_D as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
                   ...
                   upsampler=opt_net['upsampler'],
                   resi_connection=opt_net['resi_connection'])
    elif net_type == 'swinir_dense':
        from models.network_swinir import DenseSwinIR as net
        netG = net(growth_rate=opt_net['growth_rate'],
                   ...
                   upsampler=opt_net['upsampler'],
                   resi_connection=opt_net['resi_connection'])
    elif net_type == 'swinir_se':
        from models.network_swinir import SwinIR_withSE as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
                   ...
                   upsampler=opt_net['upsampler'],
                   resi_connection=opt_net['resi_connection'])
    elif net_type == 'swinir_dense_se':
        from models.network_swinir import DenseSwinIR_withSE as net
        netG = net(growth_rate=opt_net['growth_rate'],
                   upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
...
def define_G_pair(opt):
    opt_net = opt['netG']
    net_type = opt_net['net_type']

    if net_type == 'swinir_distill':
        from models.network_swinir import SwinIR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
        ...
        netG_t = net(upscale=1, in_chans=3, img_size=120, window_size=8,
